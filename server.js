<style>
                ...
                .emergency-status { background: #f8d7da; color: #721c24; padding: 15px; border-radius: 10px; margin-bottom: 20px; border-right: 4px solid #dc3545; }
            </style>
            <script>
        ...
        <body>
            <div class="container">
                ...
                <div class="emergency-status">
                    ...
                    <p>המערכת פועלת במצב ידני ללא AI. תגובות בסיסיות בלבד.</p>
                </div>
                ` : ''}
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <h3>⏱️ מצב מערכת</h3>
                        <div class="stat-number">${emergencyMode ? '🚨' : '🤖'}</div>
                        <p>${emergencyMode ? 'חירום' : 'רגיל'}</p>
                    </div>
                </div>
    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                ...
                .emergency-status { background: #f8d7da; padding: 20px; border-radius: 15px; margin-bottom: 30px; border-right: 4px solid #dc3545; }
            </style>
        </head>
        <body>
            <div class="container">
                ...
                ${emergencyMode ? `
                <div class="emergency-status">
                    <h3>🚨 מצב חירום במערכת AI</h3>
                    <p>OpenAI זמני לא זמין - הדר פועלת במצב ידני</p>
                    <p>המערכת תחזור לפעולה רגילה אוטומטית</p>
                </div>
                ` : `
...
app.get('/api/status', (req, res) => {
    res.json({
        ...
        ai: {
            ...
            status: emergencyMode ? 'emergency_mode' : 'active',
            features: ['memory', 'context', 'auto-summary', 'emergency-fallback']
        }
    });
});
    ...
    try {
        ...
        res.send(`
            <div dir="rtl" style="font-family: Arial; padding: 30px; max-width: 1200px; margin: 0 auto;">
                ...
                <div style="background: ${emergencyMode ? '#f8d7da' : '#d4edda'}; padding: 20px; border-radius: 10px; margin-bottom: 30px;">
                    <h3>${emergencyMode ? '🚨 מצב חירום פעיל' : '✅ מצב רגיל פעיל'}</h3>
                    <p><strong>סוג תגובות:</strong> ${emergencyMode ? 'ידניות (ללא AI)' : 'AI מתקדם'}</p>
                    <p><strong>זיכרון שיחות:</strong> פעיל</p>
                </div>
                    ...
                    <div style="margin-bottom: 30px; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
                        ...
                        <div style="padding: 20px;">
                            ...
                            <div style="background: #e8f5e8; padding: 15px; border-radius: 8px;">
                                <strong>👩‍💼 הדר (${emergencyMode ? 'מצב חירום' : 'עם AI'}):</strong>
                ...
                <div style="margin-top: 40px; text-align: center;">
                    ...
                    <div style="background: #f8f9fa; padding: 20px; border-radius: 10px;">
                        ...
                        <p>🚨 <strong>מצב חירום:</strong> ${emergencyMode ? 'פעיל - תגובות ידניות' : 'לא פעיל - AI מלא'}</p>
                    </div>
...
app.listen(PORT, () => {
    ...
    console.log(`🚨 מצב חירום: ${emergencyMode ? 'פעיל' : 'לא פעיל'}`);
});
...
console.log('   🚨 מצב חירום ללא AI');
console.log('   📱 ממשק ניטור WhatsApp בזמן אמת\n');
                            </div>
                        ` : `
    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                ...
                .emergency-mode { background: #f8d7da; padding: 15px; border-radius: 10px; margin: 20px 0; border-right: 4px solid #dc3545; }
            </style>
        </head>
        <body>
            <div class="container">
                ...
                <div class="emergency-mode">
                    <h3>🚨 מצב חירום פעיל</h3>
                    <p>הדר פועלת במצב ידני ללא AI</p>
                    <p>OpenAI זמני לא זמין - המערכת תחזור לפעולה רגילה בקרוב</p>
                </div>
                ` : ''}
                ...
                <div class="whatsapp-status">
                    ...
                    ${emergencyMode ? '<p>🚨 <strong>מצב חירום:</strong> תגובות ידניות</p>' : '<p>🤖 <strong>AI פעיל:</strong> תגובות חכמות</p>'}
                </div>
                ...
                <div style="margin-top: 30px; padding: 20px; background: #ecf0f1; border-radius: 10px;">
                    ...
                    <p><strong>מצב מערכת:</strong> ${emergencyMode ? '🚨 חירום (ידני)' : '🤖 רגיל (AI)'}</p>
                </div>
            </div>
...
app.get('/whatsapp-status', (req, res) => {
    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                body { font-family: Arial// קובץ: server.js משופר ותקין
...
let lastAIRequest = 0;
const AI_REQUEST_INTERVAL = 15000; // 15 שניות בין בקשות
...
class ChatSession {
    ...
    getDuration() {
        return Math.round((this.lastActivity - this.startTime) / (1000 * 60));
    }
}
