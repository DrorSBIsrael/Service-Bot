...
if ((msg === '2' || msg.includes('נזק')) && customer) {
    console.log(`❌ אין לקוח בנזק: ${customer.name}`);
    return { 
...
if ((msg === '3' || msg.includes('הצעת מחיר')) && customer) {
    console.log(`❌ אין לקוח בהצעת מחיר: ${customer.name}`);
    return { 
...
if ((msg === '4' || msg.includes('הדרכה')) && customer) {
    console.log(`❌ אין לקוח בהדרכה: ${customer.name}`);
    return { 
